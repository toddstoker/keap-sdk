...
class ResourceFactory
{
    ...
    private static array $classMap = [
        'affiliates' => [
            2 => \Toddstoker\KeapSdk\Resources\V2\AffiliatesResource::class,
        ],
        'appointments' => [
            1 => \Toddstoker\KeapSdk\Resources\V1\AppointmentsResource::class,
        ],
        'companies' => [
            2 => \Toddstoker\KeapSdk\Resources\V2\CompaniesResource::class,
        ],
        ...
        'products' => [
            2 => \Toddstoker\KeapSdk\Resources\V2\ProductsResource::class,
        ],
        'reports' => [
