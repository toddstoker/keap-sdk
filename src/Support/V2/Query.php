...
abstract class Query
{
     ...
     * @param  int|string|array<int|string>|DateTimeInterface  $value  Value to match
     * @return $this
     */
    public function where(string $field, int|string|array|DateTimeInterface $value): static
    {
